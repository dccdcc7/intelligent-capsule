...
class Classification(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : 'F:\pycharmproject\intelligent capsaule\yolo-pyqt\classification\safebelt_detect.pth',
        "classes_path"      : 'F:\pycharmproject\intelligent capsaule\yolo-pyqt\classification\model_data\cls_classes.txt',
        #--------------------------------------------------------------------#
        #   输入的图片大小
        #--------------------------------------------------------------------#
        "input_shape"       : [48, 48],
    ...
    def detect_image(self, image):
        ...
        #print([self.input_shape[1], self.input_shape[0]])
        #---------------------------------------------------------#
